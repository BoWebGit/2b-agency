...
export const translations = {
  uk: {
    metaDescription:
      "2b, innovative digital agency для брендів у products. Design, розробка сайтів, просування та аналіз. Будуємо brands, що продають у products.",
    ...
    cases: {
      ...
      items: [
        {
          slug: "vrublivskyi",
          url: "https://www.vrublivskyi.com/",
          img: "/images/case-1.png",
          cat: "WordPress, ACF, SEO",
          title: "Vrublivskyi",
          alt: "Vrublivskyi, кастомна тема WordPress з ACF",
          categories: ["wordpress", "webdev", "seo"],
          platform: "WordPress",
          design: "Готовий макет у Figma",
          roles: ["Розробка", "ACF", "SEO"],
          description:
            "Завдання полягало в розробці теми WordPress з можливістю редагування контенту через ACF. Дизайн був готовий у Figma — наша частина: верстка, кастомні поля та технічна SEO-оптимізація.",
        },
        {
          slug: "ostero-gloves",
        ...
        {
          slug: "lumeraskinlab",
          url: "https://lumeraskinlab.com/",
          img: "/images/case-4.png",
          cat: "WordPress, Figma to code",
          title: "Lumera Skin Lab",
          alt: "Lumera Skin Lab, верстка на WordPress за дизайном з Figma",
          categories: ["wordpress", "webdev"],
          platform: "WordPress",
          design: "Готовий макет у Figma",
          roles: ["Розробка"],
          description:
            "Сайт на WordPress, зверстаний за готовим дизайном з Figma.",
        },
        {
          slug: "anybusiness",
          url: "https://anybusiness.com.ua/",
          img: "/images/case-5.png",
          cat: "WordPress, Figma to code",
          title: "AnyBusiness",
          alt: "AnyBusiness, верстка на WordPress за готовим дизайном",
          categories: ["wordpress", "webdev"],
          platform: "WordPress",
          design: "Готовий макет",
          roles: ["Розробка"],
          description: "Сайт на WordPress, зверстаний за готовим дизайном.",
        },
        {
          slug: "vam",
          url: "https://vam.com.ua/",
          img: "/images/case-6.png",
          cat: "WordPress, Figma to code",
          title: "VAM",
          alt: "VAM, верстка на WordPress за дизайном з Figma",
          categories: ["wordpress", "webdev"],
          platform: "WordPress",
          design: "Готовий макет у Figma",
          roles: ["Розробка"],
        ...
        {
          slug: "walnut-house",
          url: "https://www.walnut.house/",
          img: "/images/case-7.png",
          cat: "WordPress, Figma to code",
          title: "Walnut House",
          alt: "Walnut House, верстка на WordPress за дизайном з Figma",
          categories: ["wordpress", "webdev"],
          platform: "WordPress",
          design: "Готовий макет у Figma",
          roles: ["Розробка"],
    ...
    newsPage: {
      eyebrow: "Blog",
      title: "Усі новини",
      lead: "Думки, інсайти та новини команди 2b - все в одному місці.",
      back: "Усі новини",
    ...
    contacts: {
      ...
      location: "Київ · Україна / remote worldwide",
      nameLabel: "Ваше імʼя",
      emailLabel: "Email",
  ...
  en: {
      ...
      items: [
        {
          ...
          cat: "WordPress, ACF, SEO",
          title: "Vrublivskyi",
          alt: "Vrublivskyi, custom WordPress theme with ACF",
          categories: ["wordpress", "webdev", "seo"],
          platform: "WordPress",
          design: "Ready-made Figma design",
          roles: ["Development", "ACF", "SEO"],
          description:
            "The task was to build a WordPress theme with content editable via ACF. The design was ready in Figma - our part was the build, custom fields, and technical SEO.",
        },
        {
          slug: "ostero-gloves",
          url: "https://www.ostero-gloves.com/",
        ...
        },
        {
          ...
          cat: "WordPress, Figma to code",
          title: "Lumera Skin Lab",
          alt: "Lumera Skin Lab, WordPress build from a Figma design",
          categories: ["wordpress", "webdev"],
          platform: "WordPress",
          design: "Ready-made Figma design",
          roles: ["Development"],
          description: "A WordPress site built from a ready-made Figma design.",
        },
        {
          slug: "anybusiness",
          url: "https://anybusiness.com.ua/",
          ...
          cat: "WordPress, Figma to code",
          title: "AnyBusiness",
          alt: "AnyBusiness, WordPress build from a ready-made design",
          categories: ["wordpress", "webdev"],
          platform: "WordPress",
          design: "Ready-made design",
          roles: ["Development"],
          description: "A WordPress site built from a ready-made design.",
        },
        {
          slug: "vam",
          url: "https://vam.com.ua/",
          ...
          cat: "WordPress, Figma to code",
          title: "VAM",
          alt: "VAM, WordPress build from a Figma design",
          categories: ["wordpress", "webdev"],
          platform: "WordPress",
          design: "Ready-made Figma design",
          roles: ["Development"],
        ...
        },
        {
          ...
          cat: "WordPress, Figma to code",
          title: "Walnut House",
          alt: "Walnut House, WordPress build from a Figma design",
          categories: ["wordpress", "webdev"],
          platform: "WordPress",
          design: "Ready-made Figma design",
          roles: ["Development"],
    ...
    newsPage: {
      eyebrow: "Blog",
      title: "All news",
      lead: "Thoughts, insights and news from the 2b team - all in one place.",
      back: "All news",
    ...
    contacts: {
      ...
      location: "Kyiv · Ukraine / remote worldwide",
      nameLabel: "Your name",
      emailLabel: "Email",
