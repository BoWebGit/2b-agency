...
export const translations = {
  uk: {
    ...
    cases: {
      ...
      items: [
        {
          cat: "Брендинг, E-commerce",
          title: "Norta Coffee",
          alt: "Norta Coffee, branding and e-commerce",
        },
        {
          cat: "Product design, Web",
          title: "Lumen Bank",
          alt: "Lumen Bank, product design and web",
        },
        {
          cat: "Website, SEO",
          title: "Verde Estate",
          alt: "Verde Estate, website and SEO",
        },
        {
          cat: "Design, Performance",
          title: "Pulse Fitness",
          alt: "Pulse Fitness, design and performance",
        },
      ],
    },
    ...
    casesPage: {
      ...
      items: [
        ...
        },
        {
          ...
          cat: "WordPress, Брендинг",
          alt: "Solaris Studio, WordPress and branding",
          categories: ["wordpress", "design"],
        },
        {
          title: "Atlas Logistics",
          cat: "WordPress, SEO",
          alt: "Atlas Logistics, WordPress and SEO",
          categories: ["wordpress", "marketing"],
        },
        {
          title: "Velvet Beauty",
          cat: "E-commerce, Дизайн",
          alt: "Velvet Beauty, e-commerce and design",
          categories: ["ecommerce", "design"],
        },
        {
          title: "Northwind Capital",
          cat: "Розробка, Маркетинг",
          alt: "Northwind Capital, web development and marketing",
          categories: ["webdev", "marketing"],
        },
      ],
    },
  ...
  en: {
    ...
    casesPage: {
      ...
      items: [
        ...
        {
          title: "Velvet Beauty",
          cat: "E-commerce, Design",
          alt: "Velvet Beauty, e-commerce and design",
          categories: ["ecommerce", "design"],
        },
        {
          title: "Northwind Capital",
          cat: "Development, Marketing",
          alt: "Northwind Capital, web development and marketing",
          categories: ["webdev", "marketing"],
        },
      ],
    ...
    newsPage: {
      ...
      items: [
        ...
        },
        {
          ...
          date: "09.04.2026",
          title: "Metrics a brand should actually track",
          excerpt: "Analytics and research: decisions based on data, not guesses.",
          img: "/images/blog-analytics.jpg",
          body: [
